...
- [PENDING_VERIFICATION] TASK-P2-004 已补齐 Dockerfile、production Compose 示例、production 配置样例、统一 `deploy.sh` 部署入口和手动 production workflow 闸门；Docker build 待具备 Docker 的环境补跑。
- [CONFIRMED] 测试矩阵草案已生成。
